...
<body>
  <div class="container-fluid">
	...
	<div >
                ...
                <div id="toolbar">
                  <button type="button" class="btn  search-btn btn-default " id="submit_agree"><i class="glyphicon glyphicon-ok"></i>通过</button>
                  <button type="button" class="btn  search-btn btn-default " id="submit_notagree"><i class="glyphicon glyphicon-remove"></i>不通过</button>
                </div>
...
<script type="text/javascript">
	$(function(){
		 $('#mytab').bootstrapTable({
             url: "http://localhost:8080/testmybatis/manager/getSendJob.json",//数据源
         ...
         $("#submit_agree").click(function(){
        	 ...
        	 if(selectList.length<1){
        		 BootstrapDialog.alert("请选择要处理的信息");
        		 return;
        	 }
        	 var student_id=selectList[0].studentId;
        	 var _id=selectList[0].id;
        	 $.ajax({
      		   type: "POST",
      		   url: "http://localhost:8080/testmybatis/manager/agree.do",
      		   data: {"studentId":student_id,"_id":_id},
      		   dataType:"json",
		 ...
		 $("#submit_notagree").click(function(){
			 var selectList=$('#mytab').bootstrapTable('getSelections');
        	 if(selectList.length<1){
        		 BootstrapDialog.alert("请选择要处理的信息");
        		 return;
        	 ...
        	 $.ajax({
      		   type: "POST",
      		   url: "http://localhost:8080/testmybatis/manager/notAgree.do",
      		   data: {"studentId":student_id,"_id":_id},
      		   dataType:"json",
      		   success: function(result){
      			   BootstrapDialog.alert(result.msg);
